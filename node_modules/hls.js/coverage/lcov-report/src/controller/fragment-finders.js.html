 ...
 */
export function findFragmentByPTS (fragPrevious, fragments, <span class="cstat-no" title="statement not covered" >bufferEnd = 0, <span class="cstat-no" title="statement not covered" >maxFragLookUpTolerance = 0) <span class="missing-if-branch" title="if path not taken" >I</span>{</span></span>
 ...
 */
export function fragmentWithinToleranceTest (<span class="cstat-no" title="statement not covered" >bufferEnd = 0, <span class="cstat-no" title="statement not covered" >maxFragLookUpTolerance = 0, candidate) <span class="missing-if-branch" title="if path not taken" >I</span>{</span></span>
