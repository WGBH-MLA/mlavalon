...
<html lang="en">
<head>
    <title>Code coverage report for tests/unit/demuxer/demuxer.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">tests/unit/demuxer</a> demuxer.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import Event from '../../../src/events.js';
...
&nbsp;
  it('Sent worker generic message', function () {
    let config = { enableWorker: true }; // Option debug : true crashes mocha
    let hls = {
      trigger: <span class="fstat-no" title="function not covered" >function (e</span>vent, data) {},
      config: config
    };
    let id = 'main';
    let demux = new Demuxer(hls, id);
