...
<html lang="en">
<head>
    <title>Code coverage report for tests/unit/controller/subtitle-track-controller.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">tests/unit/controller</a> subtitle-track-controller.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import SubtitleTrackController from '../../../src/controller/subtitle-track-controller';
...
&nbsp;
      it('stops the live reload timer if the level is not live', function () {
        subtitleTrackController.trackId = 1;
        subtitleTrackController.timer = setTimeout(<span class="fstat-no" title="function not covered" >() =&gt; {</span>}, 0);
