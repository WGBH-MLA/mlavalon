...
<html lang="en">
<head>
    <title>Code coverage report for tests/unit/controller/level-helper.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">tests/unit/controller</a> level-helper.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import * as LevelHelper from '../../../src/controller/level-helper';
...
const getIteratedSequence = (oldPlaylist, newPlaylist) =&gt; {
  ...
  LevelHelper.mapFragmentIntersection(oldPlaylist, newPlaylist, (oldFrag, newFrag) =&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (oldFrag.sn !== newFrag.sn) {
<span class="cstat-no" title="statement not covered" >      throw n</span>ew Error('Expected old frag and new frag to have the same SN');
    }
