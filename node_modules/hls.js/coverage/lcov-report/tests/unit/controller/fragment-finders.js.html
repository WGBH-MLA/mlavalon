...
<html lang="en">
<head>
    <title>Code coverage report for tests/unit/controller/fragment-finders.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">tests/unit/controller</a> fragment-finders.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { findFragmentByPDT, findFragmentByPTS, fragmentWithinToleranceTest, pdtWithinToleranceTest } from '../../../src/controller/fragment-finders';
...
&nbsp;
    it('finds a fragment with SN sequential to the previous fragment', function () {
      ...
      const resultSN = actual ? actual.sn : <span class="branch-1 cbranch-no" title="branch not covered" >-1;</span>
...
&nbsp;
    it('chooses the fragment with the next SN if its contiguous with the end of the buffer', function () {
      ...
      expect(actual).to.equal(mockFragments[1], `expected sn ${mockFragments[1].sn}, but got sn ${actual ? actual.sn : <span class="branch-1 cbranch-no" title="branch not covered" >null}`);</span>
      expect(binarySearchSpy).to.have.not.been.called;
    });
&nbsp;
...
&nbsp;
    it('is able to find the first fragment', function () {
      ...
      const resultSN = foundFragment ? foundFragment.sn : <span class="branch-1 cbranch-no" title="branch not covered" >-1;</span>
