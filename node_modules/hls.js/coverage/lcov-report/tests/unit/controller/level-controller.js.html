...
<html lang="en">
<head>
    <title>Code coverage report for tests/unit/controller/level-controller.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">tests/unit/controller</a> level-controller.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import LevelController from '../../../src/controller/level-controller';
...
&nbsp;
    it.skip('should signal altAudio if present in the manifest', <span class="fstat-no" title="function not covered" >function () {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      levelController.</span>onManifestLoaded(data);
<span class="cstat-no" title="statement not covered" >      expect(</span>triggerSpy).to.have.been.calledWith(Event.MANIFEST_PARSED, {
        altAudio: true,
        audio: false,
        audioTracks: [],
        firstLevel: 0,
