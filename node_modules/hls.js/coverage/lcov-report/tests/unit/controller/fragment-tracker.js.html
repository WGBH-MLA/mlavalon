...
<html lang="en">
<head>
    <title>Code coverage report for tests/unit/controller/fragment-tracker.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">tests/unit/controller</a> fragment-tracker.js
    </h1>
    <div class='clearfix'>
...
<a name='L465'></a><a href='#L465'>465</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import Hls from '../../../src/hls';
...
function createMockBuffer (buffered) {
  return {
    start: i =&gt; (buffered.length &gt; i) ? buffered[i].startPTS : <span class="branch-1 cbranch-no" title="branch not covered" >null,</span>
    end: i =&gt; (buffered.length &gt; i) ? buffered[i].endPTS : <span class="branch-1 cbranch-no" title="branch not covered" >null,</span>
