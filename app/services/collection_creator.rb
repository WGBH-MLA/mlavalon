class CollectionCreator
  ...
  def self.find_or_create_collection(collection_name, unit_name, collection_desc, manager)
    ...
    Admin::Collection.create!({name: collection_name, unit: unit_name, description: collection_desc, managers: [manager]})
  end
end
